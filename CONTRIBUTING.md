Contributing to Lorene Core
============================

The Lorene Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Lorene Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/lorene-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to lorene-qt
...
The following applies to code changes to the Lorene Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Lorene
Network Protocol consensus changes.

Whether a pull request is merged into Lorene Core rests with the project merge
...
Patches that change Lorene consensus rules are considerably more involved than
...
Where a patch set proposes to change the Lorene consensus, it must have been
...
The project leader is the release manager for each Lorene Core release.
