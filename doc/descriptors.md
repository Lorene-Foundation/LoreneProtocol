# Support for Output Descriptors in Lorene Core

Since Lorene Core v0.17, there is support for Output Descriptors. This is a
...
existing Lorene Core wallets, a convenience function `combo` is
