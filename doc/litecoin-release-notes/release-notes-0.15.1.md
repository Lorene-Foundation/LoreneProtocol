Lorene Core version *0.15.1* is now available from:

  <https://download.lorene.org/lorene-0.15.1/>
...
A number of changes to the way Lorene Core deals with peer connections and invalid blocks
