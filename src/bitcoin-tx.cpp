...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " lorene-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  lorene-tx [options] <hex-tx> [commands]  Update hex-encoded lorene transaction\n" +
            "or:     lorene-tx [options] -create [commands]   Create hex-encoded lorene transaction\n" +
            "\n";
