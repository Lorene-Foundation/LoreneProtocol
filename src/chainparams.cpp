...
{
    const char* pszTimestamp = "SpaceX launches powerful Starship for third time into space. Elon is on fire!";
    const CScript genesisOutputScript = CScript() << ParseHex("042484710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        */
        ...
        genesis = CreateGenesisBlock(1712524475, 2001340432, 0x1e0ffff0, 1, 17558 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xdafc859c2bb58760e05a2be8a75d71091fe17f3c11220a6dcc02749608894150"));
        assert(genesis.hashMerkleRoot == uint256S("0x7540f464cff343d0477c00c8c83eb3ddb3304cec24e175a5f1f39d237e4bbb15"));
        ...
        vSeeds.emplace_back("seed-a.lorene.loshan.co.uk");
        /*
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.lorenetools.com");
        vSeeds.emplace_back("dnsseed.lorenepool.org");
        ...
        */
        ...
        checkpointData = {
            {
                {  0, uint256S("0xdafc859c2bb58760e05a2be8a75d71091fe17f3c11220a6dcc02749608894150")}
...
public:
    CTestNetParams() {
        ...
        */
        ...
        genesis = CreateGenesisBlock(1712524475, 447209, 0x1e0ffff0, 1, 17558 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3094fce00767286592b7c432e4fc42ddd46fd9ad780c01058dd204fdb123b97c"));
        assert(genesis.hashMerkleRoot == uint256S("0x7540f464cff343d0477c00c8c83eb3ddb3304cec24e175a5f1f39d237e4bbb15"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.lorenetools.com");
        /*
        vSeeds.emplace_back("seed-b.lorene.loshan.co.uk");
        ...
        */
        ...
        checkpointData = {
            {
                {0, uint256S("0x3094fce00767286592b7c432e4fc42ddd46fd9ad780c01058dd204fdb123b97c")}
                /*
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        */
        ...
        genesis = CreateGenesisBlock(1712524475, 0, 0x207fffff, 1, 17558 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xae7db09dc009aba6e1ec8f5356ff812aa970564fe42243b67bd5a9f086cfa80d"));
        assert(genesis.hashMerkleRoot == uint256S("0x7540f464cff343d0477c00c8c83eb3ddb3304cec24e175a5f1f39d237e4bbb15"));
        ...
        checkpointData = {
            {
                {0, uint256S("0xae7db09dc009aba6e1ec8f5356ff812aa970564fe42243b67bd5a9f086cfa80d")},
            }
        };
