...
const char * const BITCOIN_CONF_FILENAME = "lorene.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lorene";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Lorene";
#else
    // Unix-like
    return pathRet / ".lorene";
#endif
#endif
}
