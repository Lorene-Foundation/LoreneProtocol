...
"""Verify that starting lorene with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lorene with -h for help text")
        ...
        self.log.info("Start lorene with -version for version information")
        ...
        self.log.info("Start lorened with -fakearg to make sure it does not start")
